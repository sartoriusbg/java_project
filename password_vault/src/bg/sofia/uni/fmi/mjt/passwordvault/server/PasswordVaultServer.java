...
import bg.sofia.uni.fmi.mjt.passwordvault.command.CommandCreator;
...
public class PasswordVaultServer implements Runnable {
    ...
    public PasswordVaultServer(int port, CommandExecutor commandExecutor) {
        this.port = port;
